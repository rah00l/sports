...
puts '== Creating admin user to start application =='
...
country_code_data_file = File.join(Rails.root, 'data', 'country_code.txt')

# f.each_line do |line|
#   puts line
# end
# f.close
countries = File.open(country_code_data_file, "r")
